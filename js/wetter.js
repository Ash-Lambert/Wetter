 ...
 * Version 0.9.2 von Popqorn copyleft 11-01-2020       	*
 ********************************************************/
'use strict';
function wetterJson(){
    $.getJSON("http://api.openweathermap.org/data/2.5/weather?id=2953395&appid=4547f2adec926a8062406d71a2aba04c",
		...
		document.getElementById("tre").innerHTML = "Wetter für Bad Nauheim" + "<br>" + hours + ":" + minutes + "<br>";
